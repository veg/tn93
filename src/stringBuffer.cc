...
long StringBuffer::sbDefaultLength = 16, StringBuffer::sbDefaultBoost = 16,
     ...
     VectorDouble::vDefaultLength = 16, VectorDouble::vDefaultBoost = 16;
...
void
StringBuffer::swap (StringBuffer &src)
{
  long t;
...
void
StringBuffer::appendChar (const char c)
{
  long addThis;
  if (saLength == sLength)
    {
...
void
StringBuffer::appendBuffer (const char *buffer, const long length)
{
...
Vector::~Vector (void) { free (vData); }

/*----------------------------------------------------------------------------------------------------
 */

void
Vector::appendValue (const long l)
{
  long addThis;
  if (vLength == vaLength)
    {
...
void
Vector::storeValue (const long v, const unsigned long l)
{
  long addThis;
  if (l >= vaLength)
    {
...
long
Vector::value (const long idx) const
{
  /*if (idx >= vLength) {
...
void
Vector::storeVector (const Vector &v, const unsigned long l)
{
...
void
Vector::remove (const unsigned long l)
{
  if (l < vLength)
    {
...
long
Vector::extractMin (VectorDouble &values)
{
...
int
long_comp (const void *v1, const void *v2)
{
...
VectorDouble::~VectorDouble (void) { free (vData); }

/*----------------------------------------------------------------------------------------------------
 */

void
VectorDouble::appendValue (const double l)
{
  long addThis;
  if (vLength == vaLength)
    {
...
void
VectorDouble::storeValue (const double v, const unsigned long l)
{
  long addThis;
  if (l >= vaLength)
    {
