...
namespace argparse
{
    ...
    "  -c CLUSTER-TYPE          create clusters based on the following rules (default=" TO_STR (DEFAULT_CLUSTER_OP) ")\n"
    ...
    "                                    from run to run\n"
    "  -m OUTPUT-MODE           output clusters in the following format (default=" TO_STR (DEFAULT_CLUSTER_TYPE) ")\n"
